...
class MMAdoptedRule(Heuristic):
    ...
    def handle_inbound_container(self, terminal: Terminal, container: Container, container_labels: dict) -> Terminal:
        return MM_adopted_store_container(terminal, container, None, get_block_indices(terminal, None),container_labels)
    ...
    def handle_reshuffles(self, initial_terminal: Terminal, target_container: Container,
        ...
        for blocking_container in blocking_containers:
            ...
            terminal = MM_adopted_store_container(terminal, blocking_container, target_location, get_block_indices(terminal, None), container_labels)
